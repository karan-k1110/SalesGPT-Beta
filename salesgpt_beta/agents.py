...
from salesgpt_beta.chains import SalesConversationChain, StageAnalyzerChain
from salesgpt_beta.custom_invoke import CustomAgentExecutor
from salesgpt_beta.logger import time_logger
from salesgpt_beta.parsers import SalesConvoOutputParser
from salesgpt_beta.prompts import INVESTMENT_ADVISOR_TOOLS_PROMPT
from salesgpt_beta.stages import CONVERSATION_STAGES
from salesgpt_beta.templates import CustomPromptTemplateForTools
from salesgpt_beta.tools import get_tools
    ...
    def from_llm(cls, llm: ChatLiteLLM, verbose: bool = False, **kwargs) -> "SalesGPT":
        ...
        if use_tools:
            ...
            prompt = CustomPromptTemplateForTools(
                template=INVESTMENT_ADVISOR_TOOLS_PROMPT,
